...
const Pricing = () => {
  return (
    <>
      <main className="mx-auto md:mt-0 mt-10 flex flex-col w-full items-center md:gap-0 gap-6 px-4 py-10 md:w-[1200px] md:px-0 md:py-0">
        {/* heading */}
        ...
        <div className="w-full flex flex-col md:flex-row justify-between  h-[1000px] md:h-[700px]">
          ...
          <div className="md:w-[50%] w-full h-[50%] gap-5 md:h-[90%] flex flex-col">
            ...
            <ul className="text-sm md:text-xl mt-4">
              <li className="mb-5 flex border-2 p-0 border-t-0 border-l-0 border-r-0 border-blue-400">
                <Image
