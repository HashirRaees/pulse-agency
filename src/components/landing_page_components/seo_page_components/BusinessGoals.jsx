    ...
    >
      ...
      <div className="mt-8 flex flex-wrap items-center justify-between gap-3 px-4 md:gap-0 md:px-0">
        ...
        <div className="flex w-full flex-wrap justify-between gap-6">
          {/* card one  */}
          <div className="border-1 transition duration-400 hover:scale-105 flex min-h-[50px] w-full flex-col gap-3 rounded-2xl border bg-white bg-opacity-10 p-5 backdrop-blur-md md:min-h-[240px] md:w-[32%]">
            <h4>01</h4>
        ...
        <div className="md:mt-5 mt-3 flex w-full flex-wrap justify-between gap-6 md:gap-3">
          {/* card four */}
          <div className="border-1  transition duration-400 hover:scale-105 flex min-h-[50px] w-full flex-col gap-3 rounded-2xl border bg-white bg-opacity-10 p-5 backdrop-blur-md md:min-h-[240px] md:w-[23%]">
            <h4>04</h4>
            <h3 className="text-xl font-bold tracking-wide">
              Content Strategy
            </h3>
