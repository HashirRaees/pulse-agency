     ...
     className="w-full px-6 py-16 md:mx-auto md:mt-0 md:w-full md:px-0">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-between gap-3 px-4 md:mt-20 md:justify-center md:gap-4 md:px-0">
        ...
        <div className="flex w-full flex-wrap justify-center gap-6 md:gap-6">
          {/* card one  */}
          <div className="border-1 cursor-default duration-400 flex min-h-[50px] w-full flex-col justify-start gap-3 rounded-2xl border bg-white bg-opacity-10 p-5 backdrop-blur-md transition hover:scale-105 md:h-[200px] md:w-[25%] md:p-4">
          ...
          <div className="border-1 cursor-default duration-400 flex min-h-[50px] w-full flex-col justify-start gap-3 rounded-2xl border bg-white bg-opacity-10 p-5 backdrop-blur-md transition hover:scale-105 md:h-[200px] md:w-[25%] md:p-4">
            ...
            <h2 className="text-xl font-semibold">
              Strategy Development Tailored <br />
             to your Business
            </h2>
          </div>
